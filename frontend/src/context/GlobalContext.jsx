...
useEffect(() => {
  ...
  return <GlobalContext.Provider value={{authUser,setAuthUser,authToken,setAuthToken,privateKey,selectedConversation,setSelectedConversation,messages,setMessages}}>
    {children}
